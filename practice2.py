#python program to make simple GUI Calculator
...
Button(root,text="7",width=5,height=1,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#800080",command=lambda:show("7")).place(x=10,y=200)
...
Button(root,text="4",width=5,height=1,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#800080",command=lambda:show("4")).place(x=10,y=300)
...
Button(root,text="1",width=5,height=1,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#800080",command=lambda:show("1")).place(x=10,y=400)
